...
API_ID = int(environ.get('API_ID', '7463094'))
API_HASH = environ.get('API_HASH', 'fdaaebbe4b3b1c0b38f63d9858c15dda')
BOT_TOKEN = environ.get('BOT_TOKEN', '2125773317:AAHrW-zEBvg4wNfnrm9D5nDA8eLSdJAc8vU')
...
PICS = (environ.get('PICS', 'https://telegra.ph/file/8fa444a080426d84673ef.jpg')).split()

# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '1456247312').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001558070025')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001735477454'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://auto:auto@cluster0.kd4sw.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
